...
<html prefix="og: http://ogp.me/ns#" lang="en-GB" dir="ltr">
	<head>
		<title>renew_all - BSCRA New2024</title>
		<meta charset="utf-8" />
		<!--[if IE]><meta http-equiv="ImageToolbar" content="False" /><![endif]-->
		<meta name="generator" content="Incomedia WebSite X5 Pro 2024.4.6 - www.websitex5.com" />
		<meta property="og:locale" content="en" />
		<meta property="og:type" content="website" />
		<meta property="og:url" content="http://localhost/renew_all.php" />
		<meta property="og:title" content="renew_all" />
		...
		<style type="text/css">#pluginAppObj_22_04 { width: 100%; }</style>
		<link rel="stylesheet" href="pcss/renew_all.css?2024-4-6-1-638698575597531966" media="screen,print" />
		...
		<script>
			...
			x5engine.utils.currentPagePath = 'renew_all.php';
	...
	<body>
		<div id="imPageExtContainer">
			<div id="imPageIntContainer">
				...
				<div id="imPage">
					<header id="imHeader">
						<h1 class="imHidden">renew_all - BSCRA New2024</h1>
...
$(function () {$('#imStickyBar_imMenuObject_03_container ul li').not('.imMnMnSeparator').each(function () {    var $this = $(this), timeout = 0, subtimeout = 0, width = 'none', height = 'none';        var submenu = $this.children('ul').add($this.find('.multiple-column > ul'));    $this.on('mouseenter', function () {        if($(this).parents('#imStickyBar_imMenuObject_03_container-menu-opened').length > 0) return;         clearTimeout(timeout);        clearTimeout(subtimeout);        $this.children('.multiple-column').show(0);        submenu.stop(false, false);        if (width == 'none') {             width = submenu.width();        }        if (height == 'none') {            height = submenu.height();            submenu.css({ overflow : 'hidden', height: 0});        }        setTimeout(function () {         submenu.css({ overflow : 'hidden'}).fadeIn(1).animate({ height: height }, 300, null, function() {$(this).css('overflow', 'visible'); });        }, 250);    }).on('mouseleave', function () {        if($(this).parents('#imStickyBar_imMenuObject_03_container-menu-opened').length > 0) return;         timeout = setTimeout(function () {         submenu.stop(false, false);            submenu.css('overflow', 'hidden').animate({ height: 0 }, 300, null, function() {$(this).fadeOut(0); });            subtimeout = setTimeout(function () { $this.children('.multiple-column').hide(0); }, 300);        }, 250);    });});});
					...
					<main id="imContent">
						...
						<div id="imCell_2" class=""> <div id="imCellStyleGraphics_2"></div><div id="imCellStyleBorders_2"></div><div id="imObjectTitle_22_02"><span id ="imObjectTitle_22_02_text" >Process Payment</span></div></div><div id="imPageRow_2" class="imPageRow">
						
						</div>
						<div id="imCell_1" class=""> <div id="imCellStyleGraphics_1"></div><div id="imCellStyleBorders_1"></div><div id="imHTMLObject_22_01" class="imHTMLObject" style="text-align: center; width: 100%; overflow: hidden;"><?php
						echo "INCLUDE RENEW_ALL<br><br>";
						include 'A24_incl_renew_ALL.php';
						?>
						</div></div><div id="imCell_4" class=""> <div id="imCellStyleGraphics_4"></div><div id="imCellStyleBorders_4"></div><!-- Simple Separator v.2 --><div id="pluginAppObj_22_04">
						            <div style="width: 100%; height: 100px"></div>
						        </div></div><div id="imCell_3" class=""> <div id="imCellStyleGraphics_3"></div><div id="imCellStyleBorders_3"></div><div id="imObjectButton_22_03"><button type="button" id="imObjectButton_22_03_button" onclick="x5engine.utils.location('index.php', null, false);">Go Back</button></div></div>
					</main>
					<footer id="imFooter">
